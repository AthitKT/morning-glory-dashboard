...
# ==========================================
tab_main, tab_compare = st.tabs(["🌱 สถานะเรียลไทม์ (Real-time)", "📊 เปรียบเทียบผลการทดลอง "])
...
with tab_compare:
    ...
    st.markdown("เปรียบเทียบข้อมูลการเจริญเติบโต และสภาพแวดล้อมโดยเฉลี่ยจากข้อมูลที่จัดเก็บในฐานข้อมูลเดียวกัน")
